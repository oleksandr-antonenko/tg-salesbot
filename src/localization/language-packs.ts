...
Для начала давайте познакомимся! Как вас зовут? 😊`,
  ...
  uk: {
    ...
    welcomeMessage: `🤖 Привіт! Я ІІ-помічник Олександра Антоненко, готовий показати, як чат-боти можуть революціонізувати продажі бізнесу!

Олександр Антоненко — досвідчений Tech Lead та підприємець, який допоміг незліченним компаніям збільшити доходи за допомогою розумних чат-ботів.
...
Для початку давайте познайомимося! Як вас звати? 😊`,
    ...
    stageInstructions: {
      ...
      contact_collection:
        "ФІНАЛЬНА СТАДІЯ: Якщо контакти ще не отримані - запитайте їх. Якщо контакти отримані - скажіть 'Дякую! Олександр Антоненко зв'яжеться з вами найближчим часом. Також можете написати йому напряму: @aleksandr_antonenko' і ЗАВЕРШІТЬ розмову.",
      conversation_completed:
        "РОЗМОВА ЗАВЕРШЕНА: Подякуйте за час, підтвердьте що Олександр Антоненко зв'яжеться, дайте контакт @aleksandr_antonenko. Більше НЕ ставте запитань. Просто ввічливо завершіть.",
    },
